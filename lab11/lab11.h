...
// You must pass a function of this type to some of the BST functions.  The purpose of this
// sort of function is to get an integer that represents the "key" for whatever you passed in.
// Note the the function you implement will "know" what type the void * really is.  We use
// void * so your BST can hold ANY data type.
typedef int (*GETKEYFUNCTION)(void *);

// Here is another delegate that allows you to print out whatever is actually pointed to 
